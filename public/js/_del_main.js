let sketch = function(p) {
    let initial_size = 5;
    let initial_deviation = 20;
    let deviation = 100;
    let number_of_interpolations = 10; //interpolations control from out
    let number_of_layers = 4;
    let shapes_per_layer = 40;
  
    let points;
    let current;
  
    let filename = 'data landscape';
    ...
    p.setup = function() {
      var canvas = p.createCanvas(3000, 1500);
